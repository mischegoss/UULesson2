...
//Check out the Inquirer page to figure out how this works.
...
/* Okay, this is not that different from the ajax call. YOu call axios and then get 
   (remeber GET is a method to retreive data). It is going to take in the url.

   THEN you are going to get a response. It looks like the response contains something called data
   and in that data one layer down is the imdbRating.
